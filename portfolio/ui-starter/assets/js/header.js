...
function doHalfImgRight() {
  document
    ...
    .classList.remove("text-center-desktop");
  // if buttons present
...
document
  .querySelector("#dd_text_length")
  .addEventListener("change", doTextLength);

function doTextLength() {
  let opt = document.querySelector("#dd_text_length").value;
  if (opt === "0") {
    document
      .querySelector("header.hero-block h1")
      .classList.remove("text-long");
    document
      .querySelector("header.hero-block h2")
      .classList.remove("text-long");
    document.querySelector("header.hero-block h1").innerHTML = "Lorem Malesua";
    document.querySelector("header.hero-block h2").innerHTML =
      "Etiam tincidunt risus nec odio sollin.";
  } else if (opt === "1") {
    ...
    document.querySelector("header.hero-block h1").innerHTML =
      "Praesent ornare ipsum sit amet massa convallis fringillan ullam leo mollis.";
    document.querySelector("header.hero-block h2").innerHTML =
      "Etiam tincidunt risus nec odio sollin.";
  }
}
...
function removeH2() {
  ...
  let element_h2 = Array.prototype.slice.call(
...
function doH1Shadow() {
  ...
  if (opt === "0") {
    document
      .querySelector("header.hero-block .hero-text-container h1")
      .classList.remove("text-shadow");
  } else if (opt === "1") {
    document
      .querySelector("header.hero-block .hero-text-container h1")
      .classList.add("text-shadow");
  }
}
...
function doH2Shadow() {
  ...
  if (opt === "0") {
    document
      .querySelector("header.hero-block .hero-text-container h2")
      .classList.remove("text-shadow");
  } else if (opt === "1") {
    document
      .querySelector("header.hero-block .hero-text-container h2")
...
document
  .querySelector("#dd_align_desktop")
  .addEventListener("change", doAlignDesktop);
...
function doAlignDesktop() {
  ...
  if (opt === "0") {
    document
      .querySelector(".hero-text-container")
      .classList.add("text-center-desktop");
    // if buttons present
    if (document.querySelector(".container-btn")) {
      document
        .querySelector(".container-btn")
...
document
  .querySelector("#dd_align_mobile")
  .addEventListener("change", doAlignMobile);
...
function doAlignMobile() {
  ...
  if (opt === "0") {
    document
      .querySelector(".hero-text-container")
      .classList.add("text-center-mobile");
    // if buttons present
    if (document.querySelector(".container-btn")) {
      document
        .querySelector(".container-btn")
      ...
      document
        .querySelector(".container-btn")
        .classList.remove("text-left-mobile");
    }
  } else if (opt === "1") {
    document
      .querySelector(".hero-text-container")
      .classList.remove("text-center-mobile");
    // if buttons present
    if (document.querySelector(".container-btn")) {
      document
        .querySelector(".container-btn")
      ...
      document
        .querySelector(".container-btn")
        .classList.add("text-left-mobile");
    }
  }
}
...
document
  .querySelector("#dd_text_slide")
  .addEventListener("change", doTextAnimation);
...
document
  .querySelector("#dd_hero_buttons")
  .addEventListener("change", doHeroButtons);
function doHeroButtons() {
  ...
  // one button
    ...
    if (document.querySelector("h2")) {
      document
        .querySelector("h2")
        .insertAdjacentHTML("afterend", assets_header_buttons_one);
    } else {
      document
        .querySelector("h1")
        .insertAdjacentHTML("afterend", assets_header_buttons_one);
  ...
  // two buttons
    ...
    if (document.querySelector("h2")) {
      document
        .querySelector("h2")
        .insertAdjacentHTML("afterend", assets_header_buttons_pair);
    } else {
      document
        .querySelector("h1")
        .insertAdjacentHTML("afterend", assets_header_buttons_pair);
